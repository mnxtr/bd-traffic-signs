...
def create_ssd_model(backbone='mobilenet', num_classes=91, pretrained=True):
    ...
    if backbone == 'mobilenet':
        if pretrained:
            ...
            pretrained_model = ssdlite320_mobilenet_v3_large(weights=SSDLite320_MobileNet_V3_Large_Weights.DEFAULT)
                ...
                for line in f:
                    ...
                    if len(parts) >= 5:
                        ...
                        if x2 > x1 and y2 > y1:
                            ...
                            labels.append(class_id + 1) # Add 1 because 0 is background in SSD
...
def main():
    ...
    parser.add_argument('--data-root', type=str, required=True, help='Root directory of dataset (containing train/val/test)')
    ...
    parser.add_argument('--debug', action='store_true', help='Run in debug mode (1 batch per epoch)')
